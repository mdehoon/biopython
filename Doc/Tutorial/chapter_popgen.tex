\chapter{biopython.PopGen: Population genetics}
\label{chapter:popgen}

\verb|biopython.PopGen| is a Biopython module supporting population genetics,
...
\verb|biopython.PopGen| provides a parser and generator of GenePop file format.
