\chapter{biopython.phenotype: analyse phenotypic data}
\label{chapter:phenotype}

This chapter gives an overview of the functionalities of the
\verb|biopython.phenotype| module included in Biopython. The scope of this
module is the analysis of phenotypic data, which means parsing and
analysing growth measurements of cell cultures.
In its current state the module is focused on the analysis of
...
The \verb|biopython.phenotype| module can parse two different formats of
