...
EXCLUDE_DOCTEST_MODULES = [
    "biopython.PDB",
    "biopython.PDB.AbstractPropertyMap",
    "biopython.Phylo.Applications._Fasttree",
    "biopython.Phylo._io",
    "biopython.Phylo.TreeConstruction",
    "biopython.Phylo._utils",
]

# Exclude modules with online activity
# They are not excluded by default, use --offline to exclude them
ONLINE_DOCTEST_MODULES = [ "biopython.Entrez", "biopython.ExPASy", "biopython.TogoWS"]
...
\verb|biopython.SeqIO| doctests for an example of this.
