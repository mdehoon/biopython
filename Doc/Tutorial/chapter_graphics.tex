...
The \verb|biopython.Graphics| module depends on the third party Python library
...
The \verb|biopython.Graphics.GenomeDiagram| module was added to Biopython 1.50,
...
\begin{minted}{python}
from biopython.Graphics.GenomeDiagram import FeatureSet as GDFeatureSet, Diagram as GDDiagram
...
\begin{minted}{python}
from biopython.Graphics.GenomeDiagram import FeatureSet, Diagram
...
\verb|biopython.SeqUtils| later on.
%TODO - Deal with GenomeDiagram.GDUtilities

\section{Chromosomes}

The \verb|biopython.Graphics.BasicChromosome| module allows drawing of chromosomes.
...
and then parsed them with \verb|biopython.SeqIO| to find out their lengths.  You
