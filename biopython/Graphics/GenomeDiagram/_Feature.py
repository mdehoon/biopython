...
Provides:
 - Feature - class to wrap biopython.SeqFeature objects with drawing information
...
class Feature:
    """Class to wrap biopython.SeqFeature objects for GenomeDiagram.
    ...
    Attributes:
     ...
     - name_qualifiers   List of Strings, describes the qualifiers that may
       contain feature names in the wrapped biopython.SeqFeature object
    ...
    def __init__(
        ...
        Arguments:
         ...
         - feature   biopython.SeqFeature object to be wrapped
        ...
        self.border = border
        self._feature = None  # biopython.SeqFeature object to wrap
    ...
    def set_feature(self, feature):
        """Define the biopython.SeqFeature object to be wrapped."""
    ...
    def get_feature(self):
        """Return the unwrapped biopython.SeqFeature object."""
