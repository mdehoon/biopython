...
# package.
"""biopython.Graphics offers several graphical outputs, all using ReportLab."""
...
try:
    ...
    raise MissingPythonDependencyError(
        ...
        "to use biopython.Graphics. You can find ReportLab at "
        "http://www.reportlab.com/software/opensource/"
    ) from None


# The following code is to allow all the biopython.Graphics
