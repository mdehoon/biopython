...
from biopython.codonalign.codonseq import _get_codon_list, CodonSeq, cal_dn_ds
from biopython.codonalign.chisq import chisqprob
...
class CodonAlignment(MultipleSeqAlignment):
    ...
    def get_dn_ds_matrix(self, method="NG86", codon_table=None):
        ...
        """
        from biopython.Phylo.TreeConstruction import DistanceMatrix as DM
