...
# package.
"""biopython.AlignIO support for "clustal" output from CLUSTAL W and other tools.
...
from biopython.AlignIO.Interfaces import AlignmentIterator, SequentialAlignmentWriter
...
class ClustalWriter(SequentialAlignmentWriter):
    ...
    def write_alignment(self, alignment):
        ...
        # Old versions of the parser in biopython.Clustalw used a ._version property
        try:
        ...
        if "clustal_consensus" in alignment.column_annotations:
            ...
            try:
                # This was originally stored by biopython.Clustalw as ._star_info
...
class ClustalIterator(AlignmentIterator):
    ...
    def __next__(self):
        ...
        # mimic the old parser in biopython.Clustalw
        if version:
