...
# package.
"""biopython.AlignIO support for "emboss" alignment output from EMBOSS tools.

You are expected to use this module via the biopython.AlignIO functions (or the
biopython.SeqIO functions if you want to work directly with the gapped
sequences).
...
from biopython.AlignIO.Interfaces import AlignmentIterator
