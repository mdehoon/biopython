...
are subclassed by our command line wrappers, such as:
 ...
 - biopython.Blast.Applications
 - biopython.Emboss.Applications
...
class AbstractCommandline:
    ...
    >>> from biopython.Emboss.Applications import WaterCommandline
...
def _test():
    """Run the biopython.Application module's doctests (PRIVATE)."""
    import doctest
