...
appropriate::
        ...
        from biopython.motifs.jaspar.db import JASPAR5
...
try:
    ...
    raise MissingPythonDependencyError(
        "Install MySQLdb if you want to use biopython.motifs.jaspar.db"
    )

from biopython.motifs import jaspar, matrix
...
class JASPAR5:
    ...
    def fetch_motif_by_id(self, id):
        ...
        Returns:
         - A biopython.motifs.jaspar.Motif object
    ...
    def fetch_motifs_by_name(self, name):
        ...
        Returns:
        A list of biopython.motifs.jaspar.Motif objects
    ...
    def fetch_motifs(
        ...
        Returns:
            - A biopython.motifs.jaspar.Record (list) of motifs.
    ...
    def _fetch_counts_matrix(self, int_id):
        ...
        Returns a biopython.motifs.matrix.GenericPositionMatrix
        """
        counts = {}
        cur = self.dbh.cursor()
