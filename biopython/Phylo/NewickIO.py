...
from biopython.Phylo import Newick
...
def parse(handle, **kwargs):
    ...
    :returns: generator of biopython.Phylo.Newick.Tree objects.
...
class Parser:
    ...
    Based on the parser in ``biopython.Nexus.Trees``.
    """
...
class Writer:
    """Based on the writer in biopython.Nexus.Trees (str, to_string)."""
