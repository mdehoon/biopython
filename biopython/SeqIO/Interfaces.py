...
# package.
"""biopython.SeqIO support module (not for general use).

Unless you are writing a new parser or writer for biopython.SeqIO, you should not
...
from biopython.Seq import Seq, MutableSeq, UnknownSeq
