...
# package.
"""biopython.SeqIO support for the "genbank" and "embl" file formats.

You are expected to use this module via the biopython.SeqIO functions.
Note that internally this module calls biopython.GenBank to do the actual
...
from biopython.GenBank.Scanner import GenBankScanner, EmblScanner, _ImgtScanner
...
# biopython.GenBank.Scanner (plus the _FeatureConsumer in biopython.GenBank)
...
class GenBankIterator(SequenceIterator):
    ...
    def __init__(self, source):
        ...
        This gets called internally by biopython.SeqIO for the GenBank file format:
...
class EmblIterator(SequenceIterator):
    ...
    def __init__(self, source):
        ...
        This gets called internally by biopython.SeqIO for the EMBL file format:
...
class GenBankWriter(_InsdcWriter):
    ...
    def _write_the_first_line(self, record):
        ...
        # 80 position header
            ...
            # Tests copied from biopython.GenBank.Scanner
