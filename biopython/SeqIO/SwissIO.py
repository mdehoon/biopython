...
# package.
"""biopython.SeqIO support for the "swiss" (aka SwissProt/UniProt) file format.

You are expected to use this module via the biopython.SeqIO functions.
See also the biopython.SwissProt module which offers more than just accessing
the sequences as Seq objects.

See also biopython.SeqIO.UniprotIO.py which supports the "uniprot-xml" format.
"""
...
def SwissIterator(source):
    ...
    parser via biopython.SeqIO.parse(..., format="swiss") instead.
    """
