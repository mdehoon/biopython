...
# package.
"""biopython.SeqIO support for the "pir" (aka PIR or NBRF) file format.

This module is for reading and writing PIR or NBRF format files as Seq objects.

You are expected to use this module via the biopython.SeqIO functions, or if
the file contains a sequence alignment, optionally via biopython.AlignIO instead.
