...
# biopython.Fasta.* and the now deprecated biopython.SeqIO.FASTA

"""biopython.SeqIO support for the "fasta" (aka FastA or Pearson) file format.
...
class FastaIterator(SequenceIterator):
    ...
    def __init__(self, source, alphabet=None, title2ids=None):
        ...
        By default this will act like calling biopython.SeqIO.parse(handle, "fasta")
...
class FastaWriter(SequenceWriter):
    ...
    ``biopython.SeqIO.write()`` function instead using ``format="fasta"``.
    """
