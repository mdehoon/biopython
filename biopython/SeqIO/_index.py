...
is all handled internally by the biopython.SeqIO.index(...) and index_db(...)
...
markers. We then try to extract the string that biopython.SeqIO.parse/read would
...
from biopython.File import _IndexedSeqFileProxy, _open_for_random_access
