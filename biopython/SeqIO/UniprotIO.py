...
"""biopython.SeqIO support for the "uniprot-xml" file format.

See Also:
http://www.uniprot.org

The UniProt XML format essentially replaces the old plain text file format
originally introduced by SwissProt ("swiss" format in biopython.SeqIO).
...
def UniprotIterator(source, alphabet=None, return_raw_comments=False):
    ...
    This generator can be used in biopython.SeqIO
