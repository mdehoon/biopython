...
"""biopython.SeqIO support for accessing sequences in PDB and mmCIF files."""

import collections
import warnings

from biopython import BiopythonParserWarning
from biopython.Data.SCOPData import protein_letters_3to1
...
def AtomIterator(pdb_id, structure):
    ...
    Base function for sequence parsers that read structures biopython.PDB parsers.

    Once a parser from biopython.PDB has been used to load a structure into a
    biopython.PDB.Structure.Structure object, there is no difference in how the
    ...
    Calling funtions must pass a biopython.PDB.Structure.Structure object.


    See biopython.SeqIO.PdbIO.PdbAtomIterator and biopython.SeqIO.PdbIO.CifAtomIterator for
    details.
    """
    from biopython.SeqUtils import seq1
...
class PdbSeqresIterator(SequenceIterator):
    ...
    def __init__(self, source):
        ...
        This gets called internally via biopython.SeqIO for the SEQRES based interpretation
    ...
    def iterate(self, handle):
        ...
        # Late-binding import to avoid circular dependency on SeqIO in biopython.SeqUtils
...
def PdbAtomIterator(source):
    ...
    This function uses the biopython.PDB module to do most of the hard work. The
    annotation information could be improved but this extra parsing should be
    done in parse_pdb_header, not this module.

    This gets called internally via biopython.SeqIO for the atom based interpretation
    of the PDB file format:
...
def CifSeqresIterator(source):
    ...
    This gets called internally via biopython.SeqIO for the sequence-based
