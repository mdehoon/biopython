...
from biopython.Application import _Option, _Argument, _Switch
from biopython.Application import AbstractCommandline, _ArgumentList
from biopython.Application import _StaticArgument
...
class SamtoolsReheaderCommandline(AbstractCommandline):
    ...
    Examples
    --------
    >>> from biopython.Sequencing.Applications import SamtoolsReheaderCommandline
...
class SamtoolsVersion0xSortCommandline(AbstractCommandline):
    ...
    Examples
    --------
    >>> from biopython.Sequencing.Applications import SamtoolsVersion0xSortCommandline
...
class SamtoolsFixmateCommandline(AbstractCommandline):
    ...
    Examples
    --------
    >>> from biopython.Sequencing.Applications import SamtoolsFixmateCommandline
...
class SamtoolsRmdupCommandline(AbstractCommandline):
    ...
    Examples
    --------
    >>> from biopython.Sequencing.Applications import SamtoolsRmdupCommandline
...
class SamtoolsTargetcutCommandline(AbstractCommandline):
    ...
    Examples
    --------
    >>> from biopython.Sequencing.Applications import SamtoolsTargetcutCommandline
    >>> input_bam = "/path/to/aln.bam"
...
class SamtoolsPhaseCommandline(AbstractCommandline):
    ...
    Examples
    --------
    >>> from biopython.Sequencing.Applications import SamtoolsPhaseCommandline
