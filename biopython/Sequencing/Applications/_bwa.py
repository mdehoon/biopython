...
from biopython.Application import _Option, _Argument, _Switch, AbstractCommandline
...
class BwaIndexCommandline(AbstractCommandline):
    ...
    Examples
    --------
    >>> from biopython.Sequencing.Applications import BwaIndexCommandline
...
class BwaAlignCommandline(AbstractCommandline):
    ...
    Examples
    --------
    >>> from biopython.Sequencing.Applications import BwaAlignCommandline
    >>> reference_genome = "/path/to/reference_genome.fasta"
...
class BwaSamseCommandline(AbstractCommandline):
    ...
    Examples
    --------
    >>> from biopython.Sequencing.Applications import BwaSamseCommandline
    >>> reference_genome = "/path/to/reference_genome.fasta"
    >>> read_file = "/path/to/read_1.fq"
...
class BwaSampeCommandline(AbstractCommandline):
    ...
    Examples
    --------
    >>> from biopython.Sequencing.Applications import BwaSampeCommandline
    >>> reference_genome = "/path/to/reference_genome.fasta"
...
class BwaBwaswCommandline(AbstractCommandline):
    ...
    Examples
    --------
    >>> from biopython.Sequencing.Applications import BwaBwaswCommandline
    >>> reference_genome = "/path/to/reference_genome.fasta"
    >>> read_file = "/path/to/read_1.fq"
...
class BwaMemCommandline(AbstractCommandline):
    ...
    Examples
    --------
    >>> from biopython.Sequencing.Applications import BwaMemCommandline
    >>> reference_genome = "/path/to/reference_genome.fasta"
    >>> read_file = "/path/to/read_1.fq"
    >>> output_sam_file = "/path/to/output.sam"
