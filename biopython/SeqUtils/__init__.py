...
def GC123(seq):
    ...
    >>> from biopython.SeqUtils import GC123
    >>> GC123("ACTGTN")
    (40.0, 50.0, 50.0, 0.0)
...
def seq3(seq, custom_map=None, undef_code="Xaa"):
    ...
    >>> from biopython.SeqUtils import seq3
    >>> seq3("MAIVMGRWKGAR*")
...
def six_frame_translations(seq, genetic_code=1):
    ...
    >>> from biopython.SeqUtils import six_frame_translations
    ...
    from biopython.Seq import rna_reverse_complement, translate
