...
class IsoelectricPoint:
    ...
    Parameters
    ----------
    :protein_sequence: A ``biopython.Seq`` or string object containing a protein
                       sequence.
    ...
    >>> from biopython.SeqUtils.IsoelectricPoint import IsoelectricPoint as IP
    >>> protein = IP("INGAR")
    ...
    >>> from biopython.SeqUtils.ProtParam import ProteinAnalysis as PA
    >>> protein = PA("PETER")
    ...
    def __init__(self, protein_sequence, aa_content=None):
        ...
        if not aa_content:
            from biopython.SeqUtils.ProtParam import ProteinAnalysis as _PA
