...
biopython.Wise contains modules for running and processing the output of
some of the models in the Wise2 package by Ewan Birney available from:
ftp://ftp.ebi.ac.uk/pub/software/unix/wise2/
http://www.ebi.ac.uk/Wise2/

biopython.Wise.psw is for protein Smith-Waterman alignments
biopython.Wise.dnal is for Smith-Waterman DNA alignments
"""
