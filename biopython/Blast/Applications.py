...
from biopython.Application import _Option, AbstractCommandline, _Switch
...
class NcbiblastpCommandline(_NcbiblastMain2SeqCommandline):
    ...
    >>> from biopython.Blast.Applications import NcbiblastpCommandline
...
class NcbiblastnCommandline(_NcbiblastMain2SeqCommandline):
    ...
    >>> from biopython.Blast.Applications import NcbiblastnCommandline
...
class NcbiblastxCommandline(_NcbiblastMain2SeqCommandline):
    ...
    >>> from biopython.Blast.Applications import NcbiblastxCommandline
...
class NcbitblastnCommandline(_NcbiblastMain2SeqCommandline):
    ...
    >>> from biopython.Blast.Applications import NcbitblastnCommandline
...
class NcbitblastxCommandline(_NcbiblastMain2SeqCommandline):
    ...
    >>> from biopython.Blast.Applications import NcbitblastxCommandline
...
class NcbipsiblastCommandline(_Ncbiblast2SeqCommandline):
    ...
    >>> from biopython.Blast.Applications import NcbipsiblastCommandline
...
class NcbirpsblastCommandline(_NcbiblastCommandline):
    ...
    >>> from biopython.Blast.Applications import NcbirpsblastCommandline
...
class NcbirpstblastnCommandline(_NcbiblastCommandline):
    ...
    >>> from biopython.Blast.Applications import NcbirpstblastnCommandline
...
class NcbiblastformatterCommandline(_NcbibaseblastCommandline):
    ...
    >>> from biopython.Blast.Applications import NcbiblastformatterCommandline
...
class NcbideltablastCommandline(_Ncbiblast2SeqCommandline):
    ...
    >>> from biopython.Blast.Applications import NcbideltablastCommandline
...
class NcbimakeblastdbCommandline(AbstractCommandline):
    ...
    >>> from biopython.Blast.Applications import NcbimakeblastdbCommandline
...
def _test():
    """Run the biopython.Blast.Applications module's doctests (PRIVATE)."""
    import doctest
