...
biopython.File defines private classes used in biopython.SeqIO and biopython.SearchIO for
...
def _open_for_random_access(filename):
    ...
    This functionality is used by the biopython.SeqIO and biopython.SearchIO index
...
# The rest of this file defines code used in biopython.SeqIO and biopython.SearchIO
# for indexing
...
class _IndexedSeqFileProxy:
    ...
    This is subclasses in both biopython.SeqIO for indexing as SeqRecord
    objects, and in biopython.SearchIO for indexing QueryResult objects.
...
class _IndexedSeqFileDict(collections.abc.Mapping):
    ...
    This code is used in both biopython.SeqIO for indexing as SeqRecord
    objects, and in biopython.SearchIO for indexing QueryResult objects.
    ...
    As used in biopython.SeqIO, by default the SeqRecord's id string is used
    as the dictionary key. In biopython.SearchIO, the query's id string is
