...
# package.
r"""biopython.SearchIO support for Bill Pearson's FASTA tools.
...
biopython.SearchIO.FastaIO was tested on the following FASTA flavors and versions:
...
biopython.SearchIO.FastaIO supports parsing and indexing FASTA outputs triggered by
