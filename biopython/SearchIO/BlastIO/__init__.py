...
"""biopython.SearchIO support for BLAST+ output formats.
...
biopython.SearchIO.BlastIO was tested on the following BLAST+ flavors and versions:
...
try to use the biopython.Blast module to parse them instead.
...
biopython.SearchIO.BlastIO supports the following BLAST+ output formats:
