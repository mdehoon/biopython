...
# package.
"""biopython.SearchIO support for InterProScan output formats.
...
EMBL-EBI's web page.
biopython.SearchIO.InterproscanIO was tested on the following version:
...
biopython.SearchIO.InterproscanIO supports the following format:
