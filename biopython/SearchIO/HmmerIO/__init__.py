...
# package.
"""biopython.SearchIO support for HMMER output formats.
...
biopython.SearchIO.HmmerIO was tested on the following HMMER versions and flavors:
...
biopython.SearchIO.HmmerIO supports the following HMMER output formats:
