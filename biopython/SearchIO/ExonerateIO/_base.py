...
# package.
"""biopython.SearchIO abstract base parser for Exonerate standard output format."""

import re
from functools import reduce
from abc import ABC, abstractmethod

from biopython.SearchIO._index import SearchIndexer
...
def _make_triplets(seq, phase=0):
    ...
    >>> from biopython.SearchIO.ExonerateIO._base import _make_triplets
...
def _get_fragments_coord(frags):
    ...
    >>> from biopython.SearchIO.ExonerateIO._base import _get_fragments_coord
...
def _get_fragments_phase(frags):
    ...
    >>> from biopython.SearchIO.ExonerateIO._base import _get_fragments_phase
