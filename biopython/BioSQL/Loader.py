...
# biopython
from biopython.SeqUtils.CheckSum import crc64
from biopython import Entrez
from biopython.Seq import UnknownSeq
from biopython.SeqFeature import UnknownPosition
...
class DatabaseLoader:
    ...
    def _get_taxon_id_from_ncbi_taxon_id(
        ...
        flag is true, Biopython will attempt to go online using biopython.Entrez
    ...
    def _get_taxon_id_from_ncbi_lineage(self, taxonomic_lineage):
        ...
        Arguments:
         - taxonomic_lineage - list of taxonomy dictionaries from biopython.Entrez
