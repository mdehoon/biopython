...
def read_v4(f):
    ...
    raise Exception(
        "The read_v4 function in biopython.Affy.CelFile is deprecated. "
        "Instead, please use the read function in biopython.Affy.CelFile "
...
def read_v3(handle):
    ...
    raise Exception(
        "The read_v3 function in biopython.Affy.CelFile is deprecated. "
        "Instead, please use the read function in biopython.Affy.CelFile "
