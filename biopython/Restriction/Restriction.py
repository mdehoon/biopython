...
from biopython.Restriction.Restriction_Dictionary import rest_dict as enzymedict
from biopython.Restriction.Restriction_Dictionary import typedict
from biopython.Restriction.Restriction_Dictionary import suppliers as suppliers_dict
from biopython.Restriction.PrintFormat import PrintFormat
from biopython import BiopythonWarning


# Used to use biopython.Restriction.DNAUtils.check_bases (and expose it under
# this namespace), but have deprecated that module.
...
def _check_bases(seq_string):
    ...
    ``biopython.Restriction`` doesn't use zero based counting.
    """
...
class FormattedSeq:
    ...
    Translates a biopython.Seq into a formatted sequence to be used with Restriction.
    ...
    def __init__(self, seq, linear=True):
        ...
        ``seq`` is either a ``biopython.Seq``, ``biopython.MutableSeq`` or a
    ...
    def __getitem__(self, i):
        ...
        >>> from biopython.Restriction.Restriction import FormattedSeq
...
class RestrictionType(type):
    ...
    def __truediv__(cls, other):
        ...
        >>> from biopython.Restriction import EcoRI
        >>> EcoRI/Seq('GAATTC')
        [2]
    ...
    def __ne__(cls, other):
        ...
        >>> from biopython.Restriction import SacI, SstI
    ...
    def __rshift__(cls, other):
        ...
        >>> from biopython.Restriction import SmaI, XmaI
        >>> SmaI >> XmaI
        True
        """
        if not isinstance(other, RestrictionType):
    ...
    def __mod__(cls, other):
        ...
        >>> from biopython.Restriction import XhoI, SalI
        >>> XhoI % SalI
        True
        """
        if not isinstance(other, RestrictionType):
    ...
    def __ge__(cls, other):
        ...
        >>> from biopython.Restriction import EcoRI, EcoRV
        >>> EcoRI.size
        6
        >>> EcoRV.size
        6
...
class AbstractCut(RestrictionType):
    ...
    def search(cls, dna, linear=True):
        ...
        dna must be a biopython.Seq.Seq instance or a biopython.Seq.MutableSeq instance.
    ...
    def is_equischizomer(cls, other):
        ...
        >>> from biopython.Restriction import SacI, SstI, SmaI, XmaI
...
class Defined(AbstractCut):
    ...
    def elucidate(cls):
        ...
        >>> from biopython.Restriction import EcoRI, KpnI, EcoRV, SnaI
