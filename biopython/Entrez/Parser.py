...
This parser is used by the read() function in biopython.Entrez, and is not
...
class ValidationError(ValueError):
    ...
    error. The biopython.Entrez.read and biopython.Entrez.parse functions use validating
    ...
    def __str__(self):
        ...
        return (
            ...
            "are not represented in the DTD, please call biopython.Entrez.read "
            "or biopython.Entrez.parse with validate=False." % self.name
        )
...
class DataHandler:
        ...
        try:
            ...
            if self.parser.StartElementHandler:
                ...
                raise RuntimeError(
                    ...
                    "in biopython.Entrez. Please contact the Biopython developers via "
            ...
            try:
                ...
                if self.parser.StartElementHandler:
                    ...
                    raise RuntimeError(
                        ...
                        "bug in biopython.Entrez. Please contact the Biopython "
    ...
    def handleMissingDocumentDefinition(self, tag, attrs):
        ...
        raise ValueError(
            "As the XML data contained neither a Document Type Definition (DTD) nor an XML Schema, biopython.Entrez is unable to parse these data. We recommend using a generic XML parser from the Python standard library instead, for example ElementTree."
        )
    ...
    def externalEntityRefHandler(self, context, base, systemId, publicId):
        ...
        putting them in biopython/Entrez/DTDs will allow the parser to see them.
        """
    ...
    def _initialize_directory(self):
        ...
        self.local_dtd_dir = os.path.join(self.directory, "biopython", "Entrez", "DTDs")
        os.makedirs(self.local_dtd_dir, exist_ok=True)
        # Create XSD local directory
        self.local_xsd_dir = os.path.join(self.directory, "biopython", "Entrez", "XSDs")
