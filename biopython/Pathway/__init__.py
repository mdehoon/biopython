...
biopython.Pathway is a lightweight class library designed to support the following tasks:
...
The basic object in the biopython.Pathway model is Interaction, which represents an arbitrary
...
The biopython.Pathway classes, especially Interaction, are intentionally
...
class System:
    ...
    This class is used in the biopython.Pathway framework to represent an arbitrary
